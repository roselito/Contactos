...
public class DBAdapter {
    ...
    public Contacto updateContacto(int id, String nome, String email, String telefone, Bitmap foto) {
        ContentValues values = new ContentValues();
        ...
        long insertId = database.update(dbHelper.TABLE_NAME, values, dbHelper.ID + " = " + id, null);
        // To show how to query
        Cursor cursor = database.query(dbHelper.TABLE_NAME, allColumns, dbHelper.ID + " = " + id, null, null, null, null);
        cursor.moveToFirst();
        return cursorToContacto(cursor);
    }
